import type { ModelProvider } from "@/integrations/puter";

export function ProviderIcon({ provider, size = 14 }: { provider: ModelProvider; size?: number }) {
  if (provider === "anthropic") {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <path d="M13.827 3.52h3.603L24 20.48h-3.603l-6.57-16.96zm-7.258 0h3.767L16.906 20.48h-3.674l-1.632-4.317h-6.46l-1.59 4.317H0L6.57 3.52zm1.08 5.412l-2.182 5.754h4.344l-2.163-5.754z" fill="currentColor"/>
      </svg>
    );
  }
